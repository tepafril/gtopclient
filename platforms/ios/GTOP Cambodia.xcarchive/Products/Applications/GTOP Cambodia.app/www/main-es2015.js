...
const routes = [
    ...
    {
        path: 'landing',
        loadChildren: () => Promise.all(/*! import() | pages-landing-landing-module */[__webpack_require__.e("default~pages-landing-landing-module~pages-register-register-module"), __webpack_require__.e("default~pages-forgetpassword-forgetpassword-module~pages-landing-landing-module"), __webpack_require__.e("common"), __webpack_require__.e("pages-landing-landing-module")]).then(__webpack_require__.bind(null, /*! ./pages/landing/landing.module */ "./src/app/pages/landing/landing.module.ts")).then(m => m.LandingPageModule)
    },
    {
        path: 'login',
    ...
    {
        path: 'register',
        loadChildren: () => Promise.all(/*! import() | pages-register-register-module */[__webpack_require__.e("default~pages-landing-landing-module~pages-register-register-module"), __webpack_require__.e("pages-register-register-module")]).then(__webpack_require__.bind(null, /*! ./pages/register/register.module */ "./src/app/pages/register/register.module.ts")).then(m => m.RegisterPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'dashboard',
    ...
    {
        path: 'disarm',
        loadChildren: () => Promise.all(/*! import() | pages-disarm-disarm-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-disarm-disarm-module")]).then(__webpack_require__.bind(null, /*! ./pages/disarm/disarm.module */ "./src/app/pages/disarm/disarm.module.ts")).then(m => m.DisarmPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'fuel',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-fuel-fuel-module */ "pages-fuel-fuel-module").then(__webpack_require__.bind(null, /*! ./pages/fuel/fuel.module */ "./src/app/pages/fuel/fuel.module.ts")).then(m => m.FuelPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'device',
        loadChildren: () => Promise.all(/*! import() | pages-device-device-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-device-device-module")]).then(__webpack_require__.bind(null, /*! ./pages/device/device.module */ "./src/app/pages/device/device.module.ts")).then(m => m.DevicePageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'forgetpassword',
        loadChildren: () => Promise.all(/*! import() | pages-forgetpassword-forgetpassword-module */[__webpack_require__.e("default~pages-forgetpassword-forgetpassword-module~pages-landing-landing-module"), __webpack_require__.e("pages-forgetpassword-forgetpassword-module")]).then(__webpack_require__.bind(null, /*! ./pages/forgetpassword/forgetpassword.module */ "./src/app/pages/forgetpassword/forgetpassword.module.ts")).then(m => m.ForgetpasswordPageModule)
    },
    {
        path: 'pagenotfound',
    ...
    {
        path: 'pending',
        loadChildren: () => Promise.all(/*! import() | pages-pending-pending-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-pending-pending-module")]).then(__webpack_require__.bind(null, /*! ./pages/pending/pending.module */ "./src/app/pages/pending/pending.module.ts")).then(m => m.PendingPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'pending-help',
        loadChildren: () => Promise.all(/*! import() | pages-pending-help-pending-help-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-pending-help-pending-help-module")]).then(__webpack_require__.bind(null, /*! ./pages/pending-help/pending-help.module */ "./src/app/pages/pending-help/pending-help.module.ts")).then(m => m.PendingHelpPageModule),
    },
    {
        path: 'choose-language',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-choose-language-choose-language-module */ "pages-choose-language-choose-language-module").then(__webpack_require__.bind(null, /*! ./pages/choose-language/choose-language.module */ "./src/app/pages/choose-language/choose-language.module.ts")).then(m => m.ChooseLanguagePageModule)
    },
    {
        path: 'engine',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-engine-engine-module */ "pages-engine-engine-module").then(__webpack_require__.bind(null, /*! ./pages/engine/engine.module */ "./src/app/pages/engine/engine.module.ts")).then(m => m.EnginePageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'edit-profile',
    ...
    {
        path: 'my-balance',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-my-balance-my-balance-module */ "pages-my-balance-my-balance-module").then(__webpack_require__.bind(null, /*! ./pages/my-balance/my-balance.module */ "./src/app/pages/my-balance/my-balance.module.ts")).then(m => m.MyBalancePageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'notification',
    ...
    {
        path: 'manage-group',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-manage-group-manage-group-module */ "pages-manage-group-manage-group-module").then(__webpack_require__.bind(null, /*! ./pages/manage-group/manage-group.module */ "./src/app/pages/manage-group/manage-group.module.ts")).then(m => m.ManageGroupPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'manage-icon',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-manage-icon-manage-icon-module */ "pages-manage-icon-manage-icon-module").then(__webpack_require__.bind(null, /*! ./pages/manage-icon/manage-icon.module */ "./src/app/pages/manage-icon/manage-icon.module.ts")).then(m => m.ManageIconPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'speed',
        loadChildren: () => Promise.all(/*! import() | pages-speed-speed-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-speed-speed-module")]).then(__webpack_require__.bind(null, /*! ./pages/speed/speed.module */ "./src/app/pages/speed/speed.module.ts")).then(m => m.SpeedPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'oil-maintenance',
        loadChildren: () => Promise.all(/*! import() | pages-oil-maintenance-oil-maintenance-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-oil-maintenance-oil-maintenance-module")]).then(__webpack_require__.bind(null, /*! ./pages/oil-maintenance/oil-maintenance.module */ "./src/app/pages/oil-maintenance/oil-maintenance.module.ts")).then(m => m.OilMaintenancePageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'parking-alarm',
        loadChildren: () => Promise.all(/*! import() | pages-parking-alarm-parking-alarm-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-parking-alarm-parking-alarm-module")]).then(__webpack_require__.bind(null, /*! ./pages/parking-alarm/parking-alarm.module */ "./src/app/pages/parking-alarm/parking-alarm.module.ts")).then(m => m.ParkingAlarmPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'trip',
        loadChildren: () => Promise.all(/*! import() | pages-trip-trip-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-trip-trip-module")]).then(__webpack_require__.bind(null, /*! ./pages/trip/trip.module */ "./src/app/pages/trip/trip.module.ts")).then(m => m.TripPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'trip-detail',
        loadChildren: () => Promise.all(/*! import() | pages-trip-detail-trip-detail-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-trip-detail-trip-detail-module")]).then(__webpack_require__.bind(null, /*! ./pages/trip-detail/trip-detail.module */ "./src/app/pages/trip-detail/trip-detail.module.ts")).then(m => m.TripDetailPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'tire-maintenance',
        loadChildren: () => Promise.all(/*! import() | pages-tire-maintenance-tire-maintenance-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-tire-maintenance-tire-maintenance-module")]).then(__webpack_require__.bind(null, /*! ./pages/tire-maintenance/tire-maintenance.module */ "./src/app/pages/tire-maintenance/tire-maintenance.module.ts")).then(m => m.TireMaintenancePageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'summary',
        loadChildren: () => Promise.all(/*! import() | pages-summary-summary-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-summary-summary-module")]).then(__webpack_require__.bind(null, /*! ./pages/summary/summary.module */ "./src/app/pages/summary/summary.module.ts")).then(m => m.SummaryPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'select-device',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-select-device-select-device-module */ "pages-select-device-select-device-module").then(__webpack_require__.bind(null, /*! ./pages/select-device/select-device.module */ "./src/app/pages/select-device/select-device.module.ts")).then(m => m.SelectDevicePageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'manage-group-assign-item',
        loadChildren: () => Promise.all(/*! import() | pages-manage-group-assign-item-manage-group-assign-item-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-manage-group-assign-item-manage-group-assign-item-module")]).then(__webpack_require__.bind(null, /*! ./pages/manage-group-assign-item/manage-group-assign-item.module */ "./src/app/pages/manage-group-assign-item/manage-group-assign-item.module.ts")).then(m => m.ManageGroupAssignItemPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, menuCtrl, authService, navCtrl, oneSignal, alertCtrl, alertService, languageService) {
...
/* harmony import */ var _ionic_native_safari_view_controller_ngx__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ionic-native/safari-view-controller/ngx */ "./node_modules/@ionic-native/safari-view-controller/ngx/index.js");
...
/* harmony import */ var _pages_select_device_select_device_page__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./pages/select-device/select-device.page */ "./src/app/pages/select-device/select-device.page.ts");
...
/* harmony import */ var _pages_choose_language_choose_language_page__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./pages/choose-language/choose-language.page */ "./src/app/pages/choose-language/choose-language.page.ts");
...
/* harmony import */ var _ionic_native_firebase_authentication_ngx__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @ionic-native/firebase-authentication/ngx */ "./node_modules/@ionic-native/firebase-authentication/ngx/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_21__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_22__["ENV"].FIREBASE, 'test'),
        ...
        providers: [
            ...
            _ionic_native_safari_view_controller_ngx__WEBPACK_IMPORTED_MODULE_16__["SafariViewController"],
            _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
            _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"],
            _ionic_native_badge_ngx__WEBPACK_IMPORTED_MODULE_11__["Badge"],
            _ionic_native_firebase_authentication_ngx__WEBPACK_IMPORTED_MODULE_23__["FirebaseAuthentication"],
...
ChooseLanguagePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-choose-language',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./choose-language.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/choose-language/choose-language.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./choose-language.page.scss */ "./src/app/pages/choose-language/choose-language.page.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SelectDevicePage", function() { return SelectDevicePage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
...
let SelectDevicePage = class SelectDevicePage {
    constructor(authService, requestService, modalController, alertService, storageService, navParams, loadingController) {
        this.authService = authService;
...
SelectDevicePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-select-device',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./select-device.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/select-device/select-device.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./select-device.page.scss */ "./src/app/pages/select-device/select-device.page.scss")).default]
    }),
...
let AlertService = class AlertService {
    ...
    presentToast(message, color = 'primary', intervalDuration = 5000) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    presentBottomToast(message, color = 'primary', intervalDuration = 5000) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const toast = yield this.toastController.create({
                message: message,
                duration: intervalDuration,
...
let AuthService = class AuthService {
    ...
    login(phone, password) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ENDPOINT"].API_URL + 'auth/login', { phone: phone, password: password }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(res => {
            let response = res;
            let token = {};
    ...
    logout() {
        ...
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ENDPOINT"].API_URL + 'auth/logout', { headers: headers })
    ...
    changePassword(password, newPassword, confirmPassword) {
        ...
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ENDPOINT"].API_URL + 'auth/change-password', { headers: headers,
            params: {
    ...
    editProfile(name, gender, dob, email) {
        ...
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ENDPOINT"].API_URL + 'auth/edit-profile', { headers: headers,
            params: {
                name: name,
                gender: gender,
                dob: dob,
    ...
    isUserVerified() {
        ...
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ENDPOINT"].API_URL + 'auth/is-user-verified', { headers: headers })
    ...
    checkPassport() {
        ...
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ENDPOINT"].API_URL + 'auth/check-passport', { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(res => {
            let user = res;
            this.storage.set('user', user["user"])
                .then(() => {
    ...
    register(token, password, confirmPassword, appName = 'gtopclient') {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ENDPOINT"].API_URL + 'auth/register', { token: token, password: password, password_confirmation: confirmPassword, app_name: appName });
    }
    verifyToken(token, appName = 'gtopclient') {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ENDPOINT"].API_URL + 'auth/verify-token', { token: token, app_name: appName });
    }
    resetPassword(token, password, confirmPassword, appName = 'gtopclient') {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ENDPOINT"].API_URL + 'auth/reset-password', { token: token, password: password, password_confirmation: confirmPassword, app_name: appName });
    }
    verifyPhone(phone) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ENDPOINT"].API_URL + 'auth/verify-phone', { phone: phone });
    }
    isPhoneAvailable(phone) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ENDPOINT"].API_URL + 'auth/is-phone-available', { phone: phone });
    }
};
...
let RequestService = class RequestService {
    ...
    setIcon(deviceID, iconName, iconSize) {
        ...
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ENDPOINT"].API_URL + 'item/set-icon', data, { headers: headers })
    ...
    getGroup(userid, pagination) {
        ...
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ENDPOINT"].API_URL + 'group/get-groups/' + userid + '/' + pagination, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(device => {
            return device;
        }));
    }
    createGroup(name = '') {
        ...
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ENDPOINT"].API_URL + 'group/create-group', null, options)
    ...
    updateGroup(id, name = '') {
        ...
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ENDPOINT"].API_URL + 'group/update-group', null, options)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(devices => {
            return devices;
        }));
    }
    deleteGroup(id = '') {
        ...
        return this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ENDPOINT"].API_URL + 'group/delete-group/' + id, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(devices => {
            return devices;
        }));
    }
    getGroupDevices(groupid, pagination) {
        ...
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ENDPOINT"].API_URL + 'group/get-group-devices/' + groupid + '/' + pagination, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(device => {
            return device;
        }));
    }
    getGroupUsers(groupid, pagination) {
        ...
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ENDPOINT"].API_URL + 'group/get-group-users/' + groupid + '/' + pagination, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(device => {
            return device;
        }));
    }
    attachUserToGroup(phoneNumber, groupID) {
        ...
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ENDPOINT"].API_URL + 'group/attach-user-to-group', null, options)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(devices => {
            return devices;
        }));
    }
    attachItemToGroup(itemID, groupID) {
        ...
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ENDPOINT"].API_URL + 'group/attach-item-to-group', null, options)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(devices => {
            return devices;
        }));
    }
    detachUserFromGroup(groupID, userID) {
        ...
        return this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ENDPOINT"].API_URL + 'group/detach-user-from-group/' + groupID + "/" + userID, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(devices => {
            return devices;
        }));
    }
    detachItemFromGroup(groupID, itemID) {
        ...
        return this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ENDPOINT"].API_URL + 'group/detach-item-from-group/' + groupID + "/" + itemID, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(devices => {
            return devices;
        }));
    }
    getUserItems(pagination) {
        ...
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ENDPOINT"].API_URL + 'group/get-user-items/' + pagination, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(device => {
            return device;
        }));
    }
...
let StorageService = class StorageService {
    ...
    setItem(passItem = null) {
        if (passItem == null) {
            ...
            return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ENDPOINT"].API_URL + 'item/default', { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(res => {
