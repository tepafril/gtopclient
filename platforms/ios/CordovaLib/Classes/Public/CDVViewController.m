...
- (UIView*)newCordovaViewWithFrame:(CGRect)bounds
{
    ...
    if (!defaultWebViewEngineClass) {
        defaultWebViewEngineClass = defaultWebViewEngineClass;
    }
    ...
    if (NSClassFromString(webViewEngineClass)) {
        ...
        // if a webView engine returns nil (not supported by the current iOS version) or doesn't conform to the protocol, or can't load the request, we use 
