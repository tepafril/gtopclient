...
{
    // TODO: We should figure out how to update the user-agent of existing  when this happens.
...
+ (void)setUserAgent:(NSString*)value lockToken:(NSInteger)lockToken
{
    ...
    // Setting the UserAgent must occur before a is instantiated.
    // It is read per instantiation, so it does not affect previously created views.
    // Except! When a PDF is loaded, all currently active reload their
