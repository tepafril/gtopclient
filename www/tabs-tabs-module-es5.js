  ...
  function srcAppTabsTabsRouterModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-traffic-traffic-module */
          "pages-traffic-traffic-module").then(__webpack_require__.bind(null,
          /*! ./../pages/traffic/traffic.module */
          "./src/app/pages/traffic/traffic.module.ts")).then(function (m) {
            return m.TrafficPageModule;
          });
        }
      }, {
        path: '',
