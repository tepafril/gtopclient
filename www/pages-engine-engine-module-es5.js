    ...
    function () {
      ...
      _createClass(EnginePage, [{
                      ...
                      buttons: [{
                        ...
                        handler: function handler(alertData) {
                          ...
                          if (password.length < 6) {
                            ...
                            _this3.sendCommandEngineOnOff(_this3.status, password, _this3.current_item.id);
                          }
                        }
                      }]
                    });
        ...
        value: function preparingCommand(command, password, deviceid) {
          ...
          return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_7__["ENDPOINT"].API_URL + 'command/send/traccar/' + command + '/' + password + "/" + deviceid, {
            headers: headers
